...
export interface TreatmentTypesViewMasterProps {
    entity: EntityRenderProps
    isGeneralView: boolean
}

class TreatmentTypesViewMaster extends Component<TreatmentTypesViewMasterProps> {
    render() {
        return <EntityGrid
...
export default TreatmentTypesViewMaster;
